  ...
  contenido().innerHTML = `
    <div style="display:grid;grid-template-columns:1fr 280px;gap:1.25rem;align-items:start;">
      ...
      <div>
        ...
        <!-- 5 tarjetas por método -->
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:0.85rem;margin-bottom:1.5rem;">
          ...
          <div style="padding:1rem 1.25rem;border-bottom:1px solid var(--gris-borde);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:0.75rem;">
            ...
            <div style="display:flex;align-items:center;gap:0.5rem;">
              <div style="display:flex;align-items:center;gap:0.5rem;background:var(--gris-bg);border:1px solid var(--gris-borde);border-radius:9px;padding:0.5rem 0.85rem;">
                ...
                <input type="text" id="caja-buscar" placeholder="Buscar por concepto, hab. o método…" oninput="filtrarMovimientos()" style="border:none;background:none;outline:none;font-size:0.8rem;width:200px;font-family:inherit;color:var(--texto);">
              </div>
      ...
      <div>
        <div style="background:white;border:1px solid var(--gris-borde);border-radius:14px;padding:1.25rem;">
          ...
          <div style="background:var(--gris-bg);border-radius:12px;padding:1rem;text-align:center;margin-bottom:1rem;">
            <div style="font-size:0.78rem;color:var(--texto-sub);margin-bottom:0.25rem;">Saldo en caja</div>
            <div style="font-size:1.65rem;font-weight:700;color:var(--texto);">${soles(saldoCaja)}</div>
          </div>
...
function cajaTarjeta(label, valor, color, bg, icon, movCount) {
  return `
    <div style="background:white;border:1px solid var(--gris-borde);border-radius:14px;padding:1rem;position:relative;overflow:hidden;">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:0.6rem;">
        <div style="width:36px;height:36px;border-radius:10px;background:${bg};display:flex;align-items:center;justify-content:center;">
          <svg viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;">${icon}</svg>
        </div>
        <svg viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.5" stroke-linecap="round" style="width:16px;height:16px;opacity:0.6;"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
      </div>
      <div style="font-size:0.72rem;color:var(--texto-sub);margin-bottom:0.2rem;">${label}</div>
      <div style="font-size:1.2rem;font-weight:700;color:${color==='#DC2626'?'var(--rojo)':color==='#16A34A'?'var(--verde)':color};line-height:1;">${soles(valor)}</div>
