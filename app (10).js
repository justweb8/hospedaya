    ...
    contenido().innerHTML = `
      ...
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;flex-wrap:wrap;margin-bottom:1.5rem;">
        <div style="display:flex;align-items:center;gap:1rem;">
          ...
          <div>
            ...
            <p style="font-size:0.85rem;color:var(--texto-sub);margin:0.2rem 0 0;">Gestiona las reservas próximas y mantén el control de tu ocupación</p>
          </div>
        </div>
        <button style="${ST.btnPri}; display:flex;align-items:center;gap:0.5rem;" onclick="abrirNuevaReserva()">
      ...
      <div class="card" style="padding:1rem 1.25rem;margin-bottom:1rem;">
        <div style="display:flex;align-items:center;gap:0.75rem;flex-wrap:wrap;">
          <div style="flex:1;min-width:220px;display:flex;align-items:center;gap:0.6rem;background:var(--gris-bg);border:1px solid var(--gris-borde);border-radius:10px;padding:0.55rem 0.9rem;">
          ...
          <button style="${ST.btnSec};display:flex;align-items:center;gap:0.4rem;padding:0.55rem 1rem;" onclick="exportarReservasCSV()">
      ...
      <div class="card" style="padding:0;overflow:hidden;margin-bottom:1rem;">
        ...
        <div style="padding:0.85rem 1.25rem;display:flex;align-items:center;justify-content:space-between;border-top:1px solid var(--gris-borde);font-size:0.82rem;color:var(--texto-sub);">
          <span>Mostrando ${total} de ${total} reserva${total!==1?'s':''}</span>
        </div>
      </div>

      <!-- Banner inferior -->
      <div class="card" style="background:linear-gradient(135deg,#EFF6FF 0%,#F5F3FF 100%);border:1px solid #BFDBFE;display:flex;align-items:center;gap:1.25rem;flex-wrap:wrap;">
        <div style="width:48px;height:48px;border-radius:14px;background:white;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 2px 8px rgba(37,99,235,0.15);">
          <svg viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" style="width:24px;height:24px;"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        </div>
        <div style="flex:1;">
