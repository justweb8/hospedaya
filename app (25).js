    ...
    <div class="card">
      ...
      ${_restComandas.map(c=>{
        ...
        return `<div style="display:flex;align-items:center;gap:1rem;padding:0.6rem 0;border-bottom:1px solid var(--gris-borde);">
          ...
          <span style="font-size:0.7rem;font-weight:700;color:${enPrep?'#CA8A04':'#DC2626'};background:${enPrep?'#FEFCE8':'#FEF2F2'};padding:0.2rem 0.55rem;border-radius:999px;">${enPrep?'Preparando':'Abierta'}</span>
