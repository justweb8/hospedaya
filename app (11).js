...
async function moduloReservas() {
  ...
  try {
    ...
    contenido().innerHTML = `
      ...
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;flex-wrap:wrap;margin-bottom:1.25rem;">
        <div style="display:flex;align-items:center;gap:1rem;">
          <div style="width:44px;height:44px;border-radius:12px;background:#EFF6FF;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:22px;height:22px;"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
          </div>
          <div>
            <h1 style="font-size:1.4rem;font-weight:700;color:var(--texto);margin:0;">Reservas a futuro</h1>
      ...
      <!-- Botón Nueva reserva: barra azul ancha -->
      <button onclick="abrirNuevaReserva()" style="width:100%;padding:0.9rem 1.5rem;background:var(--azul);color:white;border:none;border-radius:12px;font-size:0.92rem;font-weight:600;cursor:pointer;display:flex;align-items:center;gap:0.5rem;margin-bottom:1.25rem;transition:opacity 0.15s;" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
        <svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" style="width:17px;height:17px;"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
        Nueva reserva
      </button>

      <!-- 4 tarjetas de métricas (sin card wrapper exterior, fila limpia) -->
      ...
      <!-- Buscador + Exportar (sin card, fondo blanco directo) -->
      <div style="display:flex;align-items:center;gap:0.75rem;flex-wrap:wrap;background:white;border:1px solid var(--gris-borde);border-radius:12px;padding:0.65rem 1rem;margin-bottom:1rem;">
        ...
        <input type="text" id="res-buscar" placeholder="Buscar por huésped, habitación o fecha…" oninput="filtrarReservas()" style="flex:1;border:none;background:none;outline:none;font-size:0.85rem;color:var(--texto);font-family:inherit;min-width:160px;">
        <button style="${ST.btnSec};display:flex;align-items:center;gap:0.4rem;padding:0.45rem 0.9rem;font-size:0.82rem;" onclick="exportarReservasCSV()">
      ...
      <!-- Tabla de reservas (sin card exterior, borde directo) -->
      <div style="background:white;border:1px solid var(--gris-borde);border-radius:12px;overflow:hidden;margin-bottom:1rem;">
        ...
        <div style="padding:0.85rem 1.25rem;border-top:1px solid var(--gris-borde);font-size:0.82rem;color:var(--texto-sub);">
          Mostrando ${total} de ${total} reserva${total!==1?'s':''}
        </div>
      </div>

      <!-- Banner inferior -->
      <div style="background:white;border:1px solid var(--gris-borde);border-radius:12px;padding:1.25rem 1.5rem;display:flex;align-items:center;gap:1.25rem;flex-wrap:wrap;">
        <div style="width:44px;height:44px;border-radius:12px;background:#EFF6FF;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
          <svg viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="2" stroke-linecap="round" style="width:22px;height:22px;"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        </div>
        <div>
